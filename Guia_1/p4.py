...
def primo(x): #define si el numero es primo o no
    for i in range(2, x): #divide el numero por todos los numeros desde el 2, hasta todos numeros en adelante del 2 excepto el mismo numeto elegido y los numeros por delante 
